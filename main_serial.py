...
class Spider(object):
    ...
    def start_requests(self):
        """get urls for requests to google"""

        pool = ThreadPool()
        pool.map(self.get_data, self.companies)
        pool.close()
        pool.join()
...
if __name__ == '__main__':
    ...
    # get companies
    spider.get_companies(file)

    # start_request, get data and write to db
